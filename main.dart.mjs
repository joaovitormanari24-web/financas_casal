...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredModules, loadDeferredId} = {}) {
    ...
    const dart2wasm = {
      ...
      DI: a => a.pop(),
      DJ: (x0,x1,x2,x3) => x0.addEventListener(x1,x2,x3),
      E: (exn) => {
      ...
      EI: (o, p) => p in o,
      EJ: (x0,x1,x2,x3) => x0.removeEventListener(x1,x2,x3),
      F: () => new Error().stack,
      ...
      tI: (x0,x1,x2,x3) => x0.replaceState(x1,x2,x3),
      tJ: x0 => x0.length,
      u: () => [],
      ...
      zI: () => new Array(),
      zJ: (x0,x1) => new OffscreenCanvas(x0,x1),
